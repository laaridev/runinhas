  ...
  const handleInstall = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setErrorMessage(result.message || 'Erro desconhecido ao instalar');
        setStep('error');
      }
    } catch (error) {
      setErrorMessage('Erro ao conectar com o instalador');
      setStep('error');
    }
  };
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto bg-white dark:bg-gray-900 border border-purple-200/30 dark:border-purple-800/30 shadow-2xl shadow-purple-500/10"
            ...
            >
              ...
              <div className="flex gap-3 p-4 bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-xl border border-purple-200/40 dark:border-purple-800/30 shadow-sm hover:shadow-lg hover:border-purple-300/60 dark:hover:border-purple-700/50 transition-all duration-300">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="font-semibold text-sm mb-1.5">Como o Runinhas funciona?</h4>
                    <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                      O <span className="font-semibold text-gray-800 dark:text-gray-100">Runinhas</span> usa a tecnologia oficial da Valve, o {" "}
                      <span className="font-medium">Game State Integration (GSI)</span>, para se conectar ao Dota 2 e acompanhar sua partida em tempo real.
                    </p>
                  </div>
              ...
              <div className="flex gap-3 p-4 bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-xl border border-green-200/40 dark:border-green-800/30 shadow-sm hover:shadow-lg hover:border-green-300/60 dark:hover:border-green-700/50 transition-all duration-300">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    O GSI é uma ferramenta <span className="font-semibold">oficial e desenvolvida pela Valve</span>.
                    Não modifica arquivos do jogo, não injeta código e não interfere no funcionamento do Dota 2.
                  </p>
              ...
              <div className="flex gap-3 p-4 bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-xl border border-blue-200/40 dark:border-blue-800/30 shadow-sm hover:shadow-lg hover:border-blue-300/60 dark:hover:border-blue-700/50 transition-all duration-300">
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm">O que é Game State Integration?</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    GSI é uma <span className="font-semibold">API oficial da Valve</span> que permite que aplicações
                    externas recebam informações do jogo em tempo real. É usado por streamers,
                    torneios profissionais e overlays como Overwolf.
                  </p>
        ...
        {step === 'installing' && (
          <div className="py-12 text-center space-y-4">
            ...
            <h3 className="text-xl font-semibold">Instalando GSI...</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        {step === 'success' && (
          <div className="py-12 text-center space-y-4">
            ...
            <h3 className="text-lg font-semibold">GSI instalado com sucesso!</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <>
            <DialogHeader className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <DialogTitle className="text-xl">Erro na instalação</DialogTitle>
              </div>
            </DialogHeader>
